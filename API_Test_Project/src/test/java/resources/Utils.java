...
public class Utils {
	...
	public  RequestSpecification customerRequestSpecification() throws IOException
	{
		...
		PrintStream log =new PrintStream(new FileOutputStream("customer_logs.txt"));
		 req=new RequestSpecBuilder().setBaseUri(getGlobalValue("baseUrl")).addQueryParam("X-Oc-Merchant-Id", "123")
	...
	public static String getGlobalValue(String key) throws IOException
	{
		Properties prop =new Properties();
		 fis =new FileInputStream("C:\\Users\\Raja_Bhagya\\eclipse-workspace\\API_Test_Project\\global.properties");
		prop.load(fis);
